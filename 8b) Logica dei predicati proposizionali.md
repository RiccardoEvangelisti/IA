...
Gli [[8a) Logica dei predicati del primo ordine (FOL)#Connettivi/operatori logici|8a) Logica dei predicati del primo ordine]] sono gli stessi della Logica dei predicati del primo ordine.
La [[8a) Logica dei predicati del primo ordine (FOL)#Teoria assiomatica|Teoria assiomatica]] si applica anche a questa logica.

###### Clausola (generale)
E' una disgiunzione di [[8a) Logica dei predicati del primo ordine (FOL)#Letterale|letterali]] in cui tutte le variabili sono quantificate universalmente in modo implicito: se $a_i$ e $b_j$ sono atomi
...
---
# 2. Forward chaining
[[8a) Logica dei predicati del primo ordine (FOL)#==Correttezza== (soundness)|Corretto]] e [[8a) Logica dei predicati del primo ordine (FOL)#==Completezza== (completeness)|Completo]] per clausole di Horn.
